...
public class Authorization {
   ...
   public static void load(Engine theEngine) {
      setEngine(theEngine);
   }
   ...
   public static List<Action> getAvailableActions(List<Action> actions, User user) {
      return getAvailableActions(actions, user, null);
   }
